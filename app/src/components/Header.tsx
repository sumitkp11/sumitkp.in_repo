...
function Header() {
    return (
        <div className="flex space-x-4 bg-violet-50">
            ...
            <div className="w-1/4 md:w-1/3 p-4 grid grid-cols-2">
                <div className="invisible md:visible">
                    <header className="md:flex absolute top-10">
                        <nav className="">
                            <ul className="flex text-black md:text-xl">
                                <li className="p-4 hover:text-sky-400"><a href="">Resume</a></li>
                                <li className="p-4 hover:text-sky-400"><a href="">Career</a></li>
                                <li className="p-4 hover:text-sky-400"><a href="">Projects</a></li>
                                <li className="p-4 hover:text-sky-400"><a href="">Contact</a></li>
                            </ul>
                        </nav>
                    </header>
                </div>
            ...
            <div className="invisible md:visible w-1/3 p-4 ">
